...
**Neon Mary** is a family of themes built around the `mary.png` artwork. This repository contains fourteen variants: **Blade Runner**, **The Crow (1994)**, **Amélie (2001)**, **Tron (1982)**, **Dark City (1998)**, **The Fifth Element (1997)**, **The Grand Budapest Hotel (2014)**, **Neon Genesis Evangelion (1995)**, **The Matrix (1999)**, **Solaris (1972)**, **Suspiria (1977)**, **Akira (1988)**, **Dune (2021)**, and **The Shining (1980)**. Each variant has dark and light palette modes for terminals, editors, Omarchy, and Hermes Agent.
...
| Dark | Light |
| --- | --- |
| ![Neon Mary Akira dark desktop](screenshots/desktop-akira-dark-example.png) | ![Neon Mary Akira light desktop](screenshots/desktop-akira-light-example.png) |

### Dune (2021)

| Dark | Light |
| --- | --- |
| ![Neon Mary Dune dark desktop](screenshots/desktop-dune-dark-example.png) | ![Neon Mary Dune light desktop](screenshots/desktop-dune-light-example.png) |

### The Shining (1980)

| Dark | Light |
| --- | --- |
| ![Neon Mary The Shining dark desktop](screenshots/desktop-shining-dark-example.png) | ![Neon Mary The Shining light desktop](screenshots/desktop-shining-light-example.png) |
...
vectorized screen-print treatment of the Mary portrait across all fourteen
...
Matrix, Solaris, Suspiria, Akira, Dune, and The Shining. Each collection includes the same eight wallpaper aspect
...
same thirteen variants as an expressionistic graffiti/street series with gestural
...
| **Suspiria** | <img src="wallpapers/pop-art/suspiria/4k.png" alt="Suspiria pop-art wallpaper" width="320"> | **The Shining** | <img src="wallpapers/pop-art/shining/4k.png" alt="The Shining pop-art wallpaper" width="320"> |
| **Akira** | <img src="wallpapers/pop-art/akira/4k.png" alt="Akira pop-art wallpaper" width="320"> | **Dune** | <img src="wallpapers/pop-art/dune/4k.png" alt="Dune pop-art wallpaper" width="320"> |
...
| **Suspiria** | <img src="wallpapers/street-art/suspiria/4k.png" alt="Suspiria street-art wallpaper" width="320"> | **The Shining** | <img src="wallpapers/street-art/shining/4k.png" alt="The Shining street-art wallpaper" width="320"> |
| **Akira** | <img src="wallpapers/street-art/akira/4k.png" alt="Akira street-art wallpaper" width="320"> | **Dune** | <img src="wallpapers/street-art/dune/4k.png" alt="Dune street-art wallpaper" width="320"> |
...
- `dark`: asphalt black with Neo-Tokyo vermilion, electric blue, cyan, and warning orange.
- `light`: pale concrete with the same cyberpunk accents darkened for readable contrast.

### Dune (2021)

- `dark`: deep desert teal with spice orange, oxidized bronze, and bone white.
- `light`: sand and parchment with bronze, orange, teal, and ink accents.

### The Shining (1980)

- `dark`: winter shadow with Overlook carpet red, icy blue, mustard gold, and deep brown.
- `light`: hotel-cream with the same red, blue, and gold accents darkened for readable contrast.
...
- Neon Mary: The Matrix (1999), Solaris (1972), Suspiria (1977), Akira (1988), Dune (2021), and The Shining (1980) Omarchy packages and Hermes skins in dark/light modes.
...
# Akira (1988)
./omarchy/apply-akira.sh dark

# Dune (2021)
./omarchy/apply-dune.sh dark

# The Shining (1980)
./omarchy/apply-shining.sh dark
